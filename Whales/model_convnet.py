...
def get_conv2D(dim_input):
    config = {
        ...
        'layers': [
        ConvRectifiedLinear(layer_name='h0', output_channels=40, irange=.04, init_bias=0.,
            kernel_shape=[7, 7], pool_shape=[6, 4], pool_stride=[3, 2], W_lr_scale=0.64),
        ConvRectifiedLinear(layer_name='h1', output_channels=30, irange=.05, init_bias=0.,
            kernel_shape=[5, 5], pool_shape=[2, 2], pool_stride=[1, 1], W_lr_scale=1.),
        ConvRectifiedLinear(layer_name='h2', output_channels=20, irange=.05, init_bias=0.,
            kernel_shape=[5, 5], pool_shape=[4, 4], pool_stride=[1, 1], W_lr_scale=1.),
        ConvRectifiedLinear(layer_name='h3', output_channels=10, irange=.05, init_bias=0.,
